...
void main(void)
{
    ...
    while (1)
    {
        ...
        {
            case 0x01 : cooking_mode_display();
                                         break;

            case 0x02 : set_time(key);
                                         break;

            case 0x03 : set_time(key);
                                         break;

            case 0x04 : if( convec_mode_op == 0x09)
                                         {
                                            set_temp(key);
...
void set_time (unsigned char key)
{
    ...
    if(blink)
    {
        switch(blink_pos)
        {
            case 0 : clcd_print("  ", (0xC0 + 9));
                       break;

            case 1 : clcd_print("  ", (0xC0 + 6));
                       break;
